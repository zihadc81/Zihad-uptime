...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি পিচ্চি মিম তোমাদের মাঝে🤭!", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} CONNECTED«\n\nAssalamualaykum☘️
<------------------------------>  
...
জিহাদ কে নক করতে পারেন 
━━━━━━━━━━━━━━━━━━
[ ▶️]➜ 𝗡𝗔𝗠𝗘: 一 ɀỉꫝꪖᦔ ཐི༏ཋྀ
[ ▶️]➜ 𝗜𝗕: m.me/100067540204855
[ ▶️]➜ 𝗟𝗶𝗻𝗸𝗳𝗯: https://www.facebook.com/profile.php?id=100067540204855
━━━━━━━━━━━━━━━━━━
-
`, attachment: fs.createReadStream(__dirname + "/Nayan/join/received_1595188444667045.mp4")}, threadID));
})
.catch(error => {
    console.error(error);
});
